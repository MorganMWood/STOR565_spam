...
<center> **Table  3.**\label{table:logistic} Table displaying the estimates in the optimized logistic model after stepwise selection process. </center> \n
...
<center> **Table  5.** Table displaying the conditional probabiliteis of the Naïve Bayes model. </center> \n
...
<center> **Table  6.**Table displaying the test accuracy, true positive rate and true nagetive rate of the Naïve Bayes model. </center> \n
