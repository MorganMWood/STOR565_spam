...
cat("\nCorrect Spam: ", (t13[4]/(t13[4]+t13[2])),
  ...
  "\nAccuracy: ", mean(predictions$class==test_set$yesno))
...
```
<center> **Figure  4.** The ROC curve for LDA and QDA models are shown to both be curves above </center> \n
...
```
<center> **Figure  7.** The table above shows Correct Spam (True Positive), Correct Non-Spam (True Negative), and Overall Accuracy rates for each method used </center> \n
